/**
 * TradeFourge Companion Extension v5.1 — Exness Content Script Entry
...
(function () {
  ...
  console.log(`${TAG} Content Script Loaded (Exness Page) v5.1.0`);
  console.log(`${TAG} URL: ${window.location.href}`);
  console.log(`${TAG} Extension ID: ${chrome.runtime.id}`);
  Logger.success('ContentScript', 'TradeFourge Companion Extension v5.1 initializing on Exness page...');
