    ...
    <div className="space-y-6 text-xs font-mono pb-12">
      ...
      <div className="p-6 rounded-2xl bg-[#111522] border border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-2xl">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <Link
            href="/upload"
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-bold text-xs shadow-lg transition-all active:scale-95"
          >
        ...
        <div className="p-4 rounded-2xl bg-[#111522] border border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3 shadow-lg">
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-purple-500 text-xs"
            />
            {searchTerm && (
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            ...
            <select
              ...
              className="px-3 py-2 rounded-xl bg-[#171D2C] border border-white/10 text-white font-bold text-xs focus:outline-none focus:border-purple-500 w-full sm:w-auto"
            >
            ...
            <table className="w-full text-left font-mono text-xs">
              ...
              <tbody className="divide-y divide-white/5 text-gray-300 text-[11px]">
                {filteredImports.map((rec: any) => {
                  ...
                  return (
                    <tr key={rec.id} className={`hover:bg-purple-600/10 transition-colors ${isSelected ? "bg-purple-600/15" : ""}`}>
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          <button
                            ...
                            className="px-2.5 py-1 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 text-purple-300 font-bold text-[10px] flex items-center gap-1 transition-all"
                          ...
                          <button
                            ...
                            className="p-1.5 rounded-lg bg-purple-600/20 hover:bg-purple-600/30 border border-purple-500/30 text-purple-300 transition-all"
      ...
      {summaryRecord && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="w-full max-w-xl p-6 rounded-2xl bg-[#111522] border border-purple-500/40 space-y-5 shadow-2xl">
            ...
            <div className="flex items-center justify-between pt-2 border-t border-white/10">
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-xl bg-purple-600/20 border border-purple-500/30 hover:bg-purple-600/30 text-purple-300 font-bold text-xs flex items-center gap-1.5"
                >
